...
CREATE TABLE `project_details` (
  `gvm_budget` float DEFAULT NULL,
  `project_id` int NOT NULL AUTO_INCREMENT,
  `user_id` int DEFAULT NULL,
  `gvm_email` varchar(255) DEFAULT NULL,
  `gvm_name` varchar(255) DEFAULT NULL,
...
INSERT INTO `project_details` VALUES (899999,1,1,'test@gmail.com','test','2025-05-14','test','2024-05-01');
